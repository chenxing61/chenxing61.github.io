...
func:function()
{
	...
	*/
	...
	new G.Trait({
		...
		icon:[2,6,'H1sheet'],
		chance:1,
		req:{'tribalism':true,'forest origin':false},
	});
	new G.Trait({
		name:'desert origin',
		...
		icon:[4,9,'H1sheet'],
		chance:1,
		req:{'tribalism':true,'forest origin':false,'mountain origin':false},
	});
	new G.Trait({
		name:'jungle origin',
		...
		icon:[4,7,'H1sheet'],
		chance:1,
		req:{'tribalism':true,'forest origin':false,'mountain origin':false,'desert origin':false},
	});
	new G.Trait({
		name:'swamp origin',
		...
		icon:[14,6,'H1sheet'],
		chance:1,
		req:{'tribalism':true,'forest origin':false,'mountain origin':false,'desert origin':false,'jungle origin':false},
	});
	new G.Trait({
		name:'arctic origin',
		desc:'Your people came from tribes of the arctic, which granted them a determination to survive no matter the cost.<>@[influence] gain increased by 10%.',
		icon:[12,7,'H1sheet'],
		chance:1,
		req:{'tribalism':true,'forest origin':false,'mountain origin':false,'desert origin':false,'jungle origin':false,'swamp origin':false},
	});
	new G.Trait({
		name:'scavenging',
	...
	new G.Land({
		...
		goods:[
			...
			{type:'berry bush',chance:0.5},
			{type:'grass',amount:2},
			{type:'forest critters',chance:0.5},
			...
			{type:'river',chance:0.15,min:0.2,max:0.4},
			{type:'lake',chance:0.15,min:0.5,max:0.3},
			{type:'avians',chance:0.5,amount:0.5,amount:0.2},
	...
	new G.Land({
		...
		goods:[
			...
			{type:'lake',chance:0.05,min:0.1,max:0.2},
			{type:'river',chance:0.05,min:0.1,max:0.2},
			{type:'costal critters',chance:0.05,min:0.1,max:0.3},
			{type:'sandy soil'},
			{type:'rocky substrate'},
		],
